...
function FeaturedArticle({ title, img_url, subd, featured }) {
    return (
        <View style={{flexDirection: 'column'}}>
            ...
            <View>
                <FeaturedPictureButton
                    target={"FeaturedArticlePage_Explore"}
                    img_url={img_url}
                />
            </View>
            <View>
...
class CentralHome extends Component {
    disp() {
        const basicArticles = createGroups(articles.exp).map(([art1, art2]) =>
        ...
        return (
            <View style={styles.disp}>
                <ScrollView>
                    ...
                    <View>
                        <FeaturedArticle
                            subd={articles.exp_featured.subdivision}
                            title={articles.exp_featured.title}
                            img_url={articles.exp_featured.img_url}
                            featured={articles.exp_featured}
                        />
                    </View>
                    <View>
                        {basicArticles}
